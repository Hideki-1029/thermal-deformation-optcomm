...
from pat_acquisition.models.sunface_compo_local_los.dataset import within_case_split_mask
...
def fit_compo_local_predictions(
    ...
    x_all, feature_names, _features_df, dominant_axis = build_compo_local_features(
